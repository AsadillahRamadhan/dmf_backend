...
import MagnetArrrayService from 'App/Services/MagnetArrayService';

@inject()
export default class MagnetArraysController {
  constructor(protected service: MagnetArrrayService){}
  ...
  public async store({request, response}: HttpContextContract){
      ...
      if(!payload.name || !payload.magnet_avail){
